// https://github.com/isaac-mason/sketches/blob/main/sketches/rapier/revolute-joint-vehicle/src/sketch.tsx
...
const SteeredJoint = ({
  ...
  const left = useKeyboardControls((state) => state.leftward);
  const right = useKeyboardControls((state) => state.rightward);
  let targetPos = 0;
...
const vec3 = {
  add: (a: Vector3Tuple, b: Vector3Tuple) =>
    [a[0] + b[0], a[1] + b[1], a[2] + b[2]] as Vector3Tuple,
};
...
export const RevoluteJointVehicle = ({
  position,
